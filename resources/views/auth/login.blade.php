...
<head>
  ...
  <link rel="shortcut icon" href="/assets/images/icon-tab.svg" type="image/x-icon" />
  <link rel="shortcut icon" href="/assets/images/icon-tab.svg" type="image/png" />
  <style>
    body {
      ...
      /* background: rgb(10,0,36);
            background: linear-gradient(45deg, #0a0024 0%, #0f3c9c 50%, #00b5ff 100%); */

      background: rgb(3, 35, 97);
      background: linear-gradient(45deg, rgba(3, 35, 97, 1) 0%, rgba(22, 98, 184, 1) 50%, rgba(0, 181, 255, 1) 100%);
    }
...
<body>
  <div class="container min-vh-100 d-grid">
    <div class="row justify-content-center align-items-center p-3">
      <div class="col-xs-8 col-sm-8 col-lg-4 col-xxl-4">
        <img src="/assets/images/icon-text.svg" alt="Logo" class="w-100" />
      </div>
    </div>
